export default `<section class="py-24 relative scroll-mt-24" id="portfolio">
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
<div class="text-center mb-12" data-aos="fade-up">
<h2 class="text-3xl md:text-4xl font-bold mb-4 neon-title">
            Selected Works
          </h2>
...
<button class="tab-btn px-6 py-2 rounded-full border border-gray-700 text-gray-400 font-medium transition-all hover:border-brand-purple hover:text-brand-purple btn-pop" id="tab-web" onclick="filterProjects('web', this)">
            Websites
          </button>
<button class="tab-btn px-6 py-2 rounded-full border border-gray-700 text-gray-400 font-medium transition-all hover:border-brand-purple hover:text-brand-purple btn-pop" id="tab-branding" onclick="filterProjects('branding', this)">
            Logos &amp; Design
          </button>
<button class="tab-btn px-6 py-2 rounded-full border border-gray-700 text-gray-400 font-medium transition-all hover:border-brand-purple hover:text-brand-purple btn-pop" id="tab-qr" onclick="filterProjects('qr', this)">
            QR Solutions
          </button>
<button class="tab-btn px-6 py-2 rounded-full border border-gray-700 text-gray-400 font-medium transition-all hover:border-brand-purple hover:text-brand-purple btn-pop" id="tab-posters" onclick="filterProjects('posters', this)">
            Poster &amp; Sticker Designs
          </button>
</div>
<div class="relative px-0 md:px-0" id="projects-pager">
<button aria-label="Previous" class="absolute left-0 top-1/2 -translate-y-1/2 z-20 p-3 rounded-full bg-gray-900/40 border border-gray-700/40 text-white opacity-10 hover:opacity-60 transition-all shadow-lg backdrop-blur-sm group btn-pop" id="projects-prev">
<i class="w-6 h-6 group-hover:scale-110 transition-transform" data-feather="chevron-left"></i>
</button>
<button aria-label="Next" class="absolute right-0 top-1/2 -translate-y-1/2 z-20 p-3 rounded-full bg-gray-900/40 border border-gray-700/40 text-white opacity-10 hover:opacity-60 transition-all shadow-lg backdrop-blur-sm group btn-pop" id="projects-next">
<i class="w-6 h-6 group-hover:scale-110 transition-transform" data-feather="chevron-right"></i>
</button>
...
<a class="inline-flex items-center text-brand-blue font-semibold hover:text-white transition-colors" href="https://albertiniapavers.co.za/" target="_blank">
                  Visit Site
                  <i class="ml-2 w-4 h-4" data-feather="arrow-right"></i>
</a>
</div>
...
<a class="inline-flex items-center text-brand-blue font-semibold hover:text-white transition-colors" href="https://albertiniapavers.co.za/" target="_blank">Visit Website
                  <i class="ml-2 w-4 h-4" data-feather="arrow-right"></i></a>
</div>
</div>
<div class="project-item web group relative rounded-xl overflow-hidden glass border-0" data-aos="fade-up">
<div class="aspect-video overflow-hidden">
...
<a class="inline-flex items-center text-brand-blue font-semibold hover:text-white transition-colors" href="https://dianewhiteart.co.za/" target="_blank">
                  Visit Site
                  <i class="ml-2 w-4 h-4" data-feather="arrow-right"></i>
</a>
</div>
...
<a class="inline-flex items-center text-brand-blue font-semibold hover:text-white transition-colors" href="https://dianewhiteart.co.za/" target="_blank">Visit Website
                  <i class="ml-2 w-4 h-4" data-feather="arrow-right"></i></a>
</div>
</div>
<div class="project-item web group relative rounded-xl overflow-hidden glass border-0" data-aos="fade-up">
...
<a class="inline-flex items-center text-brand-blue font-semibold hover:text-white transition-colors" href="https://ccautorepairs.netlify.app/" target="_blank">
                  Visit Site
                  <i class="ml-2 w-4 h-4" data-feather="arrow-right"></i>
</a>
</div>
...
<a class="inline-flex items-center text-brand-blue font-semibold hover:text-white transition-colors" href="https://ccautorepairs.netlify.app/" target="_blank">Visit Website
                  <i class="ml-2 w-4 h-4" data-feather="arrow-right"></i></a>
</div>
</div>
<div class="project-item web group relative rounded-xl overflow-hidden glass border-0" data-aos="fade-up">
...
<p class="text-sm text-gray-300 mb-4">Web Design • Beauty</p>
<a class="inline-flex items-center text-brand-blue font-semibold hover:text-white transition-colors" href="https://nailsbywilma.netlify.app" target="_blank">
                  Visit Site
                  <i class="ml-2 w-4 h-4" data-feather="arrow-right"></i>
</a>
</div>
...
<a class="inline-flex items-center text-brand-blue font-semibold hover:text-white transition-colors" href="https://nailsbywilma.netlify.app" target="_blank">Visit Website
                  <i class="ml-2 w-4 h-4" data-feather="arrow-right"></i></a>
</div>
</div>
<div class="project-item web group relative rounded-xl overflow-hidden glass border-0" data-aos="fade-up">
...
<a class="inline-flex items-center text-brand-blue font-semibold hover:text-white transition-colors" href="https://ruancoetzee.co.za/" target="_blank">
                  Visit Site
                  <i class="ml-2 w-4 h-4" data-feather="arrow-right"></i>
</a>
</div>
...
<a class="inline-flex items-center text-brand-blue font-semibold hover:text-white transition-colors" href="https://ruancoetzee.co.za/" target="_blank">Visit Website
                  <i class="ml-2 w-4 h-4" data-feather="arrow-right"></i></a>
</div>
</div>
<div class="project-item web group relative rounded-xl overflow-hidden glass border-0" data-aos="fade-up">
...
<a class="inline-flex items-center text-brand-blue font-semibold hover:text-white transition-colors" href="https://rcdigitalcreations.co.za/" target="_blank">
                  Visit Site
                  <i class="ml-2 w-4 h-4" data-feather="arrow-right"></i>
</a>
</div>
...
<a class="inline-flex items-center text-brand-blue font-semibold hover:text-white transition-colors" href="https://rcdigitalcreations.co.za/" target="_blank">Visit Website
                  <i class="ml-2 w-4 h-4" data-feather="arrow-right"></i></a>
</div>
</div>
...
<a class="inline-flex items-center text-brand-blue font-semibold hover:text-white transition-colors" href="https://www.debrakke.co.za/" target="_blank">
                  Visit Site
                  <i class="ml-2 w-4 h-4" data-feather="arrow-right"></i>
</a>
</div>
...
<a class="inline-flex items-center text-brand-blue font-semibold hover:text-white transition-colors" href="https://www.debrakke.co.za/" target="_blank">Visit Website
                  <i class="ml-2 w-4 h-4" data-feather="arrow-right"></i></a>
</div>
</div>
...
<p class="text-sm text-gray-300">Promotional Poster</p>
</div>
</div>
<div class="project-item posters group relative rounded-xl overflow-hidden glass border-0" data-aos="fade-up">
<div class="aspect-video overflow-hidden bg-gray-900 flex items-center justify-center p-8">
...
<p class="text-sm text-gray-300">Product Sticker</p>
</div>
</div>
<div class="project-item posters group relative rounded-xl overflow-hidden glass border-0" data-aos="fade-up">
<div class="aspect-video overflow-hidden bg-gray-900 flex items-center justify-center p-8">
...
<p class="text-sm text-gray-300">Digital Integration</p>
</div>
</div>
<div class="project-item qr group relative rounded-xl overflow-hidden glass border-0" data-aos="fade-up">
<div class="aspect-video overflow-hidden bg-gray-900 flex items-center justify-center p-8">
